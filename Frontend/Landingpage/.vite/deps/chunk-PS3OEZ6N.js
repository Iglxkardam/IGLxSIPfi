...
} from "./chunk-O2PGUCC7.js";
import {
  css,
  unsafeCSS
} from "./chunk-SXECYZA5.js";
import {
  HashMD
} from "./chunk-DPKVYYBG.js";
import {
  LruMap,
  defineFormatter,
  hexToNumber,
  numberToHex
} from "./chunk-APP33MI7.js";
import {
  keccak_256
} from "./chunk-LCEHOZMT.js";
import {
  rotl,
  wrapConstructor
} from "./chunk-AMAE6TQZ.js";
import {
  A,
  C,
  E,
...
var require_dayjs_min = __commonJS({
  "node_modules/dayjs/dayjs.min.js"(exports, module) {
    !function(t2, e2) {
      ...
      "use strict";
      var t2 = 1e3, e2 = 6e4, n3 = 36e5, r2 = "millisecond", i3 = "second", s2 = "minute", u3 = "hour", a2 = "day", o2 = "week", c4 = "month", f7 = "quarter", h4 = "year", d2 = "date", l5 = "Invalid Date", $2 = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y6 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M3 = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t3) {
        ...
        var e3 = -t3.utcOffset(), n4 = Math.abs(e3), r3 = Math.floor(n4 / 60), i4 = n4 % 60;
        return (e3 <= 0 ? "+" : "-") + m2(r3, 2, "0") + ":" + m2(i4, 2, "0");
      }, m: function t3(e3, n4) {
        if (e3.date() < n4.date()) return -t3(n4, e3);
        var r3 = 12 * (n4.year() - e3.year()) + (n4.month() - e3.month()), i4 = e3.clone().add(r3, c4), s3 = n4 - i4 < 0, u4 = e3.clone().add(r3 + (s3 ? -1 : 1), c4);
        return +(-(r3 + (n4 - i4) / (s3 ? i4 - u4 : u4 - i4)) || 0);
      }, a: function(t3) {
        return t3 < 0 ? Math.ceil(t3) || 0 : Math.floor(t3);
      }, p: function(t3) {
        return { M: c4, y: h4, w: o2, d: a2, D: d2, h: u3, m: s2, s: i3, ms: r2, Q: f7 }[t3] || String(t3 || "").toLowerCase().replace(/s$/, "");
      }, u: function(t3) {
        return void 0 === t3;
      } }, g = "en", D2 = {};
      D2[g] = M3;
      var p3 = "$isDayjsObject", S3 = function(t3) {
        ...
        if ("string" == typeof e3) {
          ...
          var u4 = e3.split("-");
          if (!i4 && u4.length > 1) return t3(u4[0]);
        } else {
          var a3 = e3.name;
          D2[a3] = e3, i4 = a3;
        }
      ...
      var _2 = function() {
        ...
        return m3.parse = function(t3) {
          this.$d = function(t4) {
            ...
            if ("string" == typeof e3 && !/Z$/i.test(e3)) {
              ...
              if (r3) {
                ...
                return n4 ? new Date(Date.UTC(r3[1], i4, r3[3] || 1, r3[4] || 0, r3[5] || 0, r3[6] || 0, s3)) : new Date(r3[1], i4, r3[3] || 1, r3[4] || 0, r3[5] || 0, r3[6] || 0, s3);
              }
            }
            return new Date(e3);
          }(t3), this.init();
          ...
          var n4 = this, r3 = !!b2.u(e3) || e3, f8 = b2.p(t3), l6 = function(t4, e4) {
            var i4 = b2.w(n4.$u ? Date.UTC(n4.$y, e4, t4) : new Date(n4.$y, e4, t4), n4);
            return r3 ? i4 : i4.endOf(a2);
          }, $3 = function(t4, e4) {
            return b2.w(n4.toDate()[t4].apply(n4.toDate("s"), (r3 ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e4)), n4);
          }, y7 = this.$W, M5 = this.$M, m4 = this.$D, v4 = "set" + (this.$u ? "UTC" : "");
          switch (f8) {
            case h4:
              return r3 ? l6(1, 0) : l6(31, 11);
            case c4:
              return r3 ? l6(1, M5) : l6(0, M5 + 1);
            case o2:
              var g2 = this.$locale().weekStart || 0, D3 = (y7 < g2 ? y7 + 7 : y7) - g2;
              return l6(r3 ? m4 - D3 : m4 + (6 - D3), M5);
            case a2:
            case d2:
              return $3(v4 + "Hours", 0);
            case u3:
          ...
          var n4, o3 = b2.p(t3), f8 = "set" + (this.$u ? "UTC" : ""), l6 = (n4 = {}, n4[a2] = f8 + "Date", n4[d2] = f8 + "Date", n4[c4] = f8 + "Month", n4[h4] = f8 + "FullYear", n4[u3] = f8 + "Hours", n4[s2] = f8 + "Minutes", n4[i3] = f8 + "Seconds", n4[r2] = f8 + "Milliseconds", n4)[o3], $3 = o3 === a2 ? this.$D + (e3 - this.$W) : e3;
          if (o3 === c4 || o3 === h4) {
            var y7 = this.clone().set(d2, 1);
            y7.$d[l6]($3), y7.init(), this.$d = y7.set(d2, Math.min(this.$D, y7.daysInMonth())).$d;
          } else l6 && this.$d[l6]($3);
          ...
          var d3, l6 = this;
          r3 = Number(r3);
          var $3 = b2.p(f8), y7 = function(t3) {
            var e3 = O4(l6);
            return b2.w(e3.date(e3.date() + Math.round(t3 * r3)), l6);
          };
          if ($3 === c4) return this.set(c4, this.$M + r3);
          if ($3 === h4) return this.set(h4, this.$y + r3);
          if ($3 === a2) return y7(1);
          if ($3 === o2) return y7(7);
          var M5 = (d3 = {}, d3[s2] = e2, d3[u3] = n3, d3[i3] = t2, d3)[$3] || 1, m4 = this.$d.getTime() + r3 * M5;
          return b2.w(m4, this);
        }, m3.subtract = function(t3, e3) {
          return this.add(-1 * t3, e3);
        }, m3.format = function(t3) {
          var e3 = this, n4 = this.$locale();
          if (!this.isValid()) return n4.invalidDate || l5;
          var r3 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i4 = b2.z(this), s3 = this.$H, u4 = this.$m, a3 = this.$M, o3 = n4.weekdays, c5 = n4.months, f8 = n4.meridiem, h5 = function(t4, n5, i5, s4) {
            return t4 && (t4[n5] || t4(e3, r3)) || i5[n5].slice(0, s4);
          }, d3 = function(t4) {
            return b2.s(s3 % 12 || 12, t4, "0");
          }, $3 = f8 || function(t4, e4, n5) {
            var r4 = t4 < 12 ? "AM" : "PM";
          ...
          return r3.replace(y6, function(t4, r4) {
            return r4 || function(t5) {
              switch (t5) {
                ...
                case "MMM":
                  return h5(n4.monthsShort, a3, c5, 3);
                case "MMMM":
                  return h5(c5, a3);
                case "D":
                  return e3.$D;
                ...
                case "d":
                  return String(e3.$W);
                case "dd":
                  return h5(n4.weekdaysMin, e3.$W, o3, 2);
                case "ddd":
                  return h5(n4.weekdaysShort, e3.$W, o3, 3);
                case "dddd":
                  return o3[e3.$W];
                case "H":
                  return String(s3);
        ...
        }, m3.diff = function(r3, d3, l6) {
          var $3, y7 = this, M5 = b2.p(d3), m4 = O4(r3), v4 = (m4.utcOffset() - this.utcOffset()) * e2, g2 = this - m4, D3 = function() {
            return b2.m(y7, m4);
          };
          switch (M5) {
            case h4:
      ...
      return O4.prototype = k4, [["$ms", r2], ["$s", i3], ["$m", s2], ["$H", u3], ["$W", a2], ["$M", c4], ["$y", h4], ["$D", d2]].forEach(function(t3) {
        k4[t3[1]] = function(e3) {
          return this.$g(e3, t3[0], t3[1]);
        };
      }), O4.extend = function(t3, e3) {
        return t3.$i || (t3(e3, _2, O4), t3.$i = true), O4;
      }, O4.locale = w2, O4.isDayjs = S3, O4.unix = function(t3) {
        return O4(1e3 * t3);
...
var require_en = __commonJS({
  "node_modules/dayjs/locale/en.js"(exports, module) {
    !function(e2, n3) {
      "object" == typeof exports && "undefined" != typeof module ? module.exports = n3() : "function" == typeof define && define.amd ? define(n3) : (e2 = "undefined" != typeof globalThis ? globalThis : e2 || self).dayjs_locale_en = n3();
    }(exports, function() {
      "use strict";
  ...
  "node_modules/dayjs/plugin/relativeTime.js"(exports, module) {
    !function(r2, e2) {
      ...
      return function(r2, e2, t2) {
        ...
        t2.en.relativeTime = o2, n3.fromToBase = function(e3, n4, i4, d3, u3) {
          for (var f7, a2, s2, l5 = i4.$locale().relativeTime || o2, h4 = r2.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], m2 = h4.length, c4 = 0; c4 < m2; c4 += 1) {
            var y6 = h4[c4];
            y6.d && (f7 = d3 ? t2(e3).diff(i4, y6.d, true) : i4.diff(e3, y6.d, true));
            var p3 = (r2.rounding || Math.round)(Math.abs(f7));
            if (s2 = f7 > 0, p3 <= y6.r || !y6.r) {
              p3 <= 1 && c4 > 0 && (y6 = h4[c4 - 1]);
              var v3 = l5[y6.l];
              u3 && (p3 = u3("" + p3)), a2 = "string" == typeof v3 ? v3.replace("%d", p3) : v3(p3, n4, y6.l, s2);
              break;
            }
          }
          if (n4) return a2;
          var M3 = s2 ? l5.future : l5.past;
...
var require_updateLocale = __commonJS({
  "node_modules/dayjs/plugin/updateLocale.js"(exports, module) {
    !function(e2, n3) {
      "object" == typeof exports && "undefined" != typeof module ? module.exports = n3() : "function" == typeof define && define.amd ? define(n3) : (e2 = "undefined" != typeof globalThis ? globalThis : e2 || self).dayjs_plugin_updateLocale = n3();
    }(exports, function() {
      "use strict";
...
function parse(x2, n3) {
  ...
  if ((i3 = n3.search(/e/i)) > 0) {
    if (e2 < 0) e2 = i3;
    e2 += +n3.slice(i3 + 1);
    n3 = n3.substring(0, i3);
  } else if (e2 < 0) {
    e2 = n3.length;
  }
  nl = n3.length;
  for (i3 = 0; i3 < nl && n3.charAt(i3) == "0"; ) ++i3;
  if (i3 == nl) {
    x2.c = [x2.e = 0];
  } else {
    ...
    x2.e = e2 - i3 - 1;
    x2.c = [];
    for (e2 = 0; i3 <= nl; ) x2.c[e2++] = +n3.charAt(i3++);
  }
  return x2;
}
...
P.cmp = function(y6) {
  var isneg, x2 = this, xc3 = x2.c, yc3 = (y6 = new x2.constructor(y6)).c, i3 = x2.s, j2 = y6.s, k4 = x2.e, l5 = y6.e;
  if (!xc3[0] || !yc3[0]) return !xc3[0] ? !yc3[0] ? 0 : -j2 : i3;
  if (i3 != j2) return i3;
  isneg = i3 < 0;
  if (k4 != l5) return k4 > l5 ^ isneg ? 1 : -1;
  j2 = (k4 = xc3.length) < (l5 = yc3.length) ? k4 : l5;
  for (i3 = -1; ++i3 < j2; ) {
    if (xc3[i3] != yc3[i3]) return xc3[i3] > yc3[i3] ^ isneg ? 1 : -1;
  }
  return k4 == l5 ? 0 : k4 > l5 ^ isneg ? 1 : -1;
};
P.div = function(y6) {
  var x2 = this, Big2 = x2.constructor, a2 = x2.c, b2 = (y6 = new Big2(y6)).c, k4 = x2.s == y6.s ? 1 : -1, dp = Big2.DP;
  ...
  var bl, bt3, n3, cmp, ri3, bz = b2.slice(), ai2 = bl = b2.length, al = a2.length, r2 = a2.slice(0, bl), rl = r2.length, q3 = y6, qc2 = q3.c = [], qi4 = 0, p3 = dp + (q3.e = x2.e - y6.e) + 1;
  q3.s = k4;
  k4 = p3 < 0 ? 0 : p3;
  bz.unshift(0);
  for (; rl++ < bl; ) r2.push(0);
  ...
  } while ((ai2++ < al || r2[0] !== UNDEFINED) && k4--);
  if (!qc2[0] && qi4 != 1) {
    qc2.shift();
    q3.e--;
    p3--;
  }
  if (qi4 > p3) round(q3, p3, Big2.RM, r2[0] !== UNDEFINED);
  return q3;
};
P.eq = function(y6) {
...
P.minus = P.sub = function(y6) {
  var i3, j2, t2, xlty, x2 = this, Big2 = x2.constructor, a2 = x2.s, b2 = (y6 = new Big2(y6)).s;
  if (a2 != b2) {
    y6.s = -b2;
    return x2.plus(y6);
  }
  var xc3 = x2.c.slice(), xe3 = x2.e, yc3 = y6.c, ye4 = y6.e;
  if (!xc3[0] || !yc3[0]) {
    if (yc3[0]) {
      y6.s = -b2;
    } else if (xc3[0]) {
  ...
  if (a2 = xe3 - ye4) {
    ...
    j2 = ((xlty = xc3.length < yc3.length) ? xc3 : yc3).length;
  ...
  if ((b2 = (j2 = yc3.length) - (i3 = xc3.length)) > 0) for (; b2--; ) xc3[i3++] = 0;
  for (b2 = i3; j2 > a2; ) {
    if (xc3[--j2] < yc3[j2]) {
      for (i3 = j2; i3 && !xc3[--i3]; ) xc3[i3] = 9;
      --xc3[i3];
      xc3[j2] += 10;
    }
    xc3[j2] -= yc3[j2];
...
P.mod = function(y6) {
  var ygtx, x2 = this, Big2 = x2.constructor, a2 = x2.s, b2 = (y6 = new Big2(y6)).s;
  if (!y6.c[0]) {
    throw Error(DIV_BY_ZERO);
  }
  x2.s = y6.s = 1;
...
P.plus = P.add = function(y6) {
  var e2, k4, t2, x2 = this, Big2 = x2.constructor;
  y6 = new Big2(y6);
  if (x2.s != y6.s) {
    y6.s = -y6.s;
    return x2.minus(y6);
  }
  var xe3 = x2.e, xc3 = x2.c, ye4 = y6.e, yc3 = y6.c;
  if (!xc3[0] || !yc3[0]) {
    if (!yc3[0]) {
      if (xc3[0]) {
        y6 = new Big2(x2);
  ...
  if (xc3.length - yc3.length < 0) {
    t2 = yc3;
    yc3 = xc3;
    xc3 = t2;
  }
  e2 = yc3.length;
  for (k4 = 0; e2; xc3[e2] %= 10) k4 = (xc3[--e2] = xc3[e2] + yc3[e2] + k4) / 10 | 0;
  if (k4) {
    xc3.unshift(k4);
    ++ye4;
  }
  for (e2 = xc3.length; xc3[--e2] === 0; ) xc3.pop();
  y6.c = xc3;
  y6.e = ye4;
  return y6;
};
P.pow = function(n3) {
  var x2 = this, one = new x2.constructor("1"), y6 = one, isneg = n3 < 0;
  if (n3 !== ~~n3 || n3 < -MAX_POWER || n3 > MAX_POWER) {
    throw Error(INVALID + "exponent");
  }
  if (isneg) n3 = -n3;
  for (; ; ) {
    if (n3 & 1) y6 = y6.times(x2);
    n3 >>= 1;
    if (!n3) break;
    x2 = x2.times(x2);
  }
...
P.times = P.mul = function(y6) {
  var c4, x2 = this, Big2 = x2.constructor, xc3 = x2.c, yc3 = (y6 = new Big2(y6)).c, a2 = xc3.length, b2 = yc3.length, i3 = x2.e, j2 = y6.e;
  y6.s = x2.s == y6.s ? 1 : -1;
  if (!xc3[0] || !yc3[0]) {
    y6.c = [y6.e = 0];
    return y6;
  ...
  for (c4 = new Array(j2 = a2 + b2); j2--; ) c4[j2] = 0;
  for (i3 = b2; i3--; ) {
    b2 = 0;
    for (j2 = a2 + i3; j2 > i3; ) {
      b2 = c4[j2] + yc3[i3] * xc3[j2 - i3 - 1] + b2;
      c4[j2--] = b2 % 10;
      b2 = b2 / 10 | 0;
    }
    c4[j2] = b2;
...
var Us = class {
  ...
  process(e2, n3, r2 = false) {
    ...
    let P4 = x2 + S3 * a2 + L2 * c4 + U4 * (5 * d2) + _2 * (5 * p3) + j2 * (5 * E4);
    x2 = P4 >>> 13, P4 &= 8191, P4 += g * (5 * y6) + w2 * (5 * h4) + b2 * (5 * f7) + I2 * (5 * l5) + R3 * (5 * u3), x2 += P4 >>> 13, P4 &= 8191;
    ...
    x2 = J2 >>> 13, J2 &= 8191, J2 += g * f7 + w2 * l5 + b2 * u3 + I2 * a2 + R3 * c4, x2 += J2 >>> 13, J2 &= 8191, x2 = (x2 << 2) + x2 | 0, x2 = x2 + C4 | 0, C4 = x2 & 8191, x2 = x2 >>> 13, P4 += x2, i3[0] = C4, i3[1] = P4, i3[2] = k4, i3[3] = M3, i3[4] = D2, i3[5] = z3, i3[6] = Z2, i3[7] = st2, i3[8] = W2, i3[9] = J2;
  }
  finalize() {
...
function _s(t2, e2, n3, r2, o2, i3 = 20) {
  let s2 = t2[0], c4 = t2[1], a2 = t2[2], u3 = t2[3], l5 = e2[0], f7 = e2[1], h4 = e2[2], y6 = e2[3], E4 = e2[4], p3 = e2[5], d2 = e2[6], v3 = e2[7], m2 = o2, O4 = n3[0], N2 = n3[1], $2 = n3[2], B3 = s2, A3 = c4, T = a2, S3 = u3, L2 = l5, U4 = f7, _2 = h4, j2 = y6, g = E4, w2 = p3, b2 = d2, I2 = v3, R3 = m2, x2 = O4, C4 = N2, P4 = $2;
  for (let M3 = 0; M3 < i3; M3 += 2) B3 = B3 + L2 | 0, R3 = V(R3 ^ B3, 16), g = g + R3 | 0, L2 = V(L2 ^ g, 12), B3 = B3 + L2 | 0, R3 = V(R3 ^ B3, 8), g = g + R3 | 0, L2 = V(L2 ^ g, 7), A3 = A3 + U4 | 0, x2 = V(x2 ^ A3, 16), w2 = w2 + x2 | 0, U4 = V(U4 ^ w2, 12), A3 = A3 + U4 | 0, x2 = V(x2 ^ A3, 8), w2 = w2 + x2 | 0, U4 = V(U4 ^ w2, 7), T = T + _2 | 0, C4 = V(C4 ^ T, 16), b2 = b2 + C4 | 0, _2 = V(_2 ^ b2, 12), T = T + _2 | 0, C4 = V(C4 ^ T, 8), b2 = b2 + C4 | 0, _2 = V(_2 ^ b2, 7), S3 = S3 + j2 | 0, P4 = V(P4 ^ S3, 16), I2 = I2 + P4 | 0, j2 = V(j2 ^ I2, 12), S3 = S3 + j2 | 0, P4 = V(P4 ^ S3, 8), I2 = I2 + P4 | 0, j2 = V(j2 ^ I2, 7), B3 = B3 + U4 | 0, P4 = V(P4 ^ B3, 16), b2 = b2 + P4 | 0, U4 = V(U4 ^ b2, 12), B3 = B3 + U4 | 0, P4 = V(P4 ^ B3, 8), b2 = b2 + P4 | 0, U4 = V(U4 ^ b2, 7), A3 = A3 + _2 | 0, R3 = V(R3 ^ A3, 16), I2 = I2 + R3 | 0, _2 = V(_2 ^ I2, 12), A3 = A3 + _2 | 0, R3 = V(R3 ^ A3, 8), I2 = I2 + R3 | 0, _2 = V(_2 ^ I2, 7), T = T + j2 | 0, x2 = V(x2 ^ T, 16), g = g + x2 | 0, j2 = V(j2 ^ g, 12), T = T + j2 | 0, x2 = V(x2 ^ T, 8), g = g + x2 | 0, j2 = V(j2 ^ g, 7), S3 = S3 + L2 | 0, C4 = V(C4 ^ S3, 16), w2 = w2 + C4 | 0, L2 = V(L2 ^ w2, 12), S3 = S3 + L2 | 0, C4 = V(C4 ^ S3, 8), w2 = w2 + C4 | 0, L2 = V(L2 ^ w2, 7);
  let k4 = 0;
  r2[k4++] = s2 + B3 | 0, r2[k4++] = c4 + A3 | 0, r2[k4++] = a2 + T | 0, r2[k4++] = u3 + S3 | 0, r2[k4++] = l5 + L2 | 0, r2[k4++] = f7 + U4 | 0, r2[k4++] = h4 + _2 | 0, r2[k4++] = y6 + j2 | 0, r2[k4++] = E4 + g | 0, r2[k4++] = p3 + w2 | 0, r2[k4++] = d2 + b2 | 0, r2[k4++] = v3 + I2 | 0, r2[k4++] = m2 + R3 | 0, r2[k4++] = O4 + x2 | 0, r2[k4++] = N2 + C4 | 0, r2[k4++] = $2 + P4 | 0;
}
...
function gc(t2) {
  ...
  function f7(m2, O4) {
    ...
    for (let j2 = BigInt(o2 - 1); j2 >= Ht; j2--) {
      ...
      const w2 = B3 + A3, b2 = r2(w2 * w2), I2 = B3 - A3, R3 = r2(I2 * I2), x2 = b2 - R3, C4 = T + S3, P4 = T - S3, k4 = r2(P4 * w2), M3 = r2(C4 * I2), D2 = k4 + M3, z3 = k4 - M3;
...
function Ic(t2) {
  ...
  const { ProjectivePoint: a2, normPrivateKeyToScalar: u3, weierstrassEquation: l5, isWithinCurveOrder: f7 } = Ac({ ...e2, toBytes(g, w2, b2) {
    ...
    if (w2 === o2 && (b2 === 2 || b2 === 3)) {
      ...
      const P4 = (C4 & K2) === K2;
      return (b2 & 1) === 1 !== P4 && (C4 = n3.neg(C4)), { x: R3, y: C4 };
    } else if (w2 === i3 && b2 === 4) {
  ...
  class d2 {
    ...
    recoverPublicKey(w2) {
      ...
      const P4 = (R3 & 1) === 0 ? "02" : "03", k4 = a2.fromHex(P4 + h4(C4)), M3 = c4(C4), D2 = s2(-x2 * M3), z3 = s2(I2 * M3), Z2 = a2.BASE.multiplyAndAddUnsafe(k4, D2, z3);
  ...
  function j2(g, w2, b2, I2 = U4) {
    ...
    const { lowS: x2, prehash: C4, format: P4 } = I2;
    ...
    const k4 = typeof R3 == "string" || St(R3), M3 = !k4 && !P4 && typeof R3 == "object" && R3 !== null && typeof R3.r == "bigint" && typeof R3.s == "bigint";
    ...
    try {
      if (M3 && (D2 = new d2(R3.r, R3.s)), k4) {
        try {
          P4 !== "compact" && (D2 = d2.fromDER(R3));
        } catch (Ut2) {
          if (!(Ut2 instanceof lt.Err)) throw Ut2;
        }
        !D2 && P4 !== "der" && (D2 = d2.fromCompact(R3));
      }
      z3 = a2.fromHex(b2);
    } catch {
      return false;
...
function qc(t2, e2) {
  ...
  return oo({ type: Bt(n3.type), senderPublicKey: typeof n3.senderPublicKey < "u" ? toString2(n3.senderPublicKey, G) : void 0, receiverPublicKey: e2 == null ? void 0 : e2.receiverPublicKey });
}
function oo(t2) {
...
function zc(t2, e2) {
  ...
  if (!_c.verify(concat3([s2, c4]), u3, l5)) throw new Error("Invalid signature");
...
function Ic2(t2) {
  ...
  function j2(g, w2, b2, I2 = U4) {
    ...
    if (P4 !== void 0 && P4 !== "compact" && P4 !== "der") throw new Error("format must be compact or der");
    const k4 = typeof R3 == "string" || St3(R3), M3 = !k4 && !P4 && typeof R3 == "object" && R3 !== null && typeof R3.r == "bigint" && typeof R3.s == "bigint";
    if (!k4 && !M3) throw new Error("invalid signature, expected Uint8Array, hex string or Signature instance");
    let D2, z3;
    try {
      if (M3 && (D2 = new d2(R3.r, R3.s)), k4) {
...
@walletconnect/utils/dist/index.es.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-PS3OEZ6N.js.map

      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-lg">
            ...
            <p className="text-3xl font-bold text-white">$12,847.50</p>
            <p className="text-sm text-green-400 font-medium">+15.3% (+$1,642.50)</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-blue-300 text-sm font-medium bg-blue-500/20 px-2 py-1 rounded-lg">Monthly</span>
            </div>
            <h3 className="text-lg font-semibold text-white mb-2">DCA Amount</h3>
            <p className="text-3xl font-bold text-white">$500</p>
            <p className="text-sm text-gray-400">Next investment in 12 days</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-lg">
            ...
            <p className="text-sm text-gray-400">BTC, ETH, SOL strategies</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="p-6">
            <div className="space-y-4">
              {/* Bitcoin */}
              <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-orange-500/10">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">0.1847 BTC</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="font-semibold text-white">$7,230.50</p>
                  <p className="text-sm text-green-400">+12.5%</p>
                </div>
              </div>

              {/* Ethereum */}
              <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-blue-500/10">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">2.54 ETH</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="font-semibold text-white">$4,320.25</p>
                  <p className="text-sm text-green-400">+18.2%</p>
                </div>
              </div>

              {/* Solana */}
              <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-purple-500/10">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">65.2 SOL</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="font-semibold text-white">$1,296.75</p>
                  <p className="text-sm text-green-400">+22.1%</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-6">
            <div className="h-64 bg-white/5 rounded-xl flex items-center justify-center border border-white/10">
              <div className="text-center">
                ...
                <p className="text-gray-300 font-medium">Performance Chart</p>

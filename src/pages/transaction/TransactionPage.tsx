    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <motion.div 
          ...
          className="bg-white/5 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/10 shadow-lg mb-4 sm:mb-6"
        >
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3 sm:space-y-0">
            ...
            <div className="flex space-x-2 w-full sm:w-auto">
              <button
                ...
                className={`flex-1 sm:flex-none px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm transition-all duration-200 ${
                  filter === 'all'
        ...
        >
            ...
            <div className="space-y-3 sm:space-y-4">
              {filteredTransactions.map((transaction) => (
                <motion.div
                  ...
                  className="flex items-center justify-between p-3 sm:p-4 bg-white/5 rounded-lg sm:rounded-xl border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-200"
                >
          ...
          {/* Pagination */}
          <div className="p-4 sm:p-6 border-t border-white/10 flex items-center justify-center">
            <button className="px-4 sm:px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white text-sm sm:text-base rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-200 shadow-lg">
              Load More
            </button>
          </div>
        </motion.div>
